...
var MeteoService = /** @class */ (function () {
    ...
    MeteoService.prototype.getMeteo = function (name) {
        ...
        return fetch("'https://maps.googleapis.com/maps/api/staticmap?markers='+cityWeather.coord.lat+','+cityWeather.coord.lon+'&zoom=5&size=400x300&scale=2&key=AIzaSyAkmvI9DazzG9p77IShsz_Di7-5Qn7zkcg' ")
